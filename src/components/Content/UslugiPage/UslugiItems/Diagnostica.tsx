      ...
      <Box sx={classes.wrapper}>
        <Box sx={classes.content}>
          ...
          <Box sx={{ ...classes.descTextSection, marginTop: "20px" }}>
            ...
            консультацию, которая абсолютно бесплатна и если ситуация того требует, назначаем время диагностики. Наши специалисты сообщат Вам итоговую стоимость
            работ , на основании заключенного договора. Далее наша команда прибывает на участок к клиенту и проводит все требуемые работы под присмотром клиента.
            В процессе клиенту будет рассказано то ,что не видно обычным взглядом.
          </Box>
