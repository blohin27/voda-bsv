    ...
    <Box sx={classes.root}>
        ...
        <Box sx={classes.wrapperImg}>
          <Box sx={classes.contentImg}>
            <Box sx={{ display: "flex", justifyContent: "center", flexDirection: "column" }}>
              <h1>
                <Box sx={{ ...classes.titleGeneral, fontSize: "52px" }}>Замена гидроаккумулятора (гидробака) </Box>
              </h1>
            </Box>
          </Box>
        </Box>
      ...
      <Box sx={classes.wrapper}>
        <Box sx={classes.content}>
          ...
          <h2>
            <Box sx={{ ...classes.subTitle1 }}>Замена гидроаккумулятора (гидробака) c гарантией</Box>
          </h2>
          <Box sx={classes.descTextSection}>
            <Box sx={{ ...classes.imgSection, float: "left", height: "240px" }}>
              <Image src="/photo/gidrobak.jpg" alt={"Замена насоса  "} layout={"fill"} objectFit="cover" objectPosition="50% 20%" quality={100} />
            </Box>
            <Box>
