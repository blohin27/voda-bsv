    ...
    <Box sx={classes.root}>
        ...
        <Box sx={classes.wrapperImg}>
          <Box sx={classes.contentImg}>
            <Box sx={{ display: "flex", justifyContent: "center", flexDirection: "column" }}>
              <h1>
                <Box sx={{ ...classes.titleGeneral, fontSize: "52px" }}>Какую химию использовать для скважины </Box>
              </h1>
            </Box>
          </Box>
        </Box>
      ...
      <Box sx={classes.wrapper}>
        <Box sx={classes.content}>
          ...
          <h2>
            <Box sx={{ ...classes.subTitle1 }}>Химия для скважины</Box>
          </h2>
          <Box sx={classes.descTextSection}>
            <Box sx={{ ...classes.imgSection, float: "left", height: "240px" }}>
              <Image src="/photo/him.jpg" alt={"Химия для скважины"} layout={"fill"} objectFit="cover" objectPosition="50% 20%" quality={100} />
            </Box>
            <Box sx={{ ...classes.descTextSection }} mt={2}>
              Чистка скважин - ключевой аспект поддержания качества водоснабжения. Со временем скважины могут засоряться, что влияет на проток воды и её
              качество. Засорение может быть вызвано накоплением осадка, проникновением частиц почвы и других веществ. Это ухудшает вкусовые качества воды и
              может сделать её непригодной для употребления. Регулярная чистка помогает устранять эти загрязнения, восстанавливая производительность скважины и
              обеспечивая безопасность воды. Понимание важности такой процедуры и её регулярное выполнение способствует здоровью людей и снижает расходы на
              ремонт оборудования.
            </Box>
            <Box sx={{ ...classes.descTextSection }} mt={2}>
              Химическая очистка скважин необходима для поддержания их эффективности и качества воды. Со временем в скважинах образуются засоры из-за накопления
              минеральных отложений, ржавчины и других веществ. Эти отложения могут серьезно снизить пропускную способность скважины, что приводит к уменьшению
              объема поступающей воды и ухудшению её качества. Химическая чистка помогает растворять эти отложения, улучшая циркуляцию воды и восстанавливая
              исходную производительность скважины. Это обеспечивает стабильное водоснабжение и предотвращает возможные проблемы, связанные с загрязнением воды.
            </Box>
            <Box sx={{ ...classes.descTextSection }} mt={2}>
              При химической очистке скважин используются различные реагенты, каждый из которых имеет свои особенности в плане эффективности и безопасности.
              Обычно выбор реагента зависит от типа загрязнения. Например, для устранения минеральных отложений могут использоваться сильные кислоты, в то время
              как для борьбы с биологическими загрязнителями более подходящими будут окислители. Важно подчеркнуть, что безопасность применения химических
              реагентов зависит от правильности их использования и соблюдения мер предосторожности, особенно когда речь идет о скважинах, используемых для
              питьевой воды.
            </Box>
          </Box>
          <h2>
