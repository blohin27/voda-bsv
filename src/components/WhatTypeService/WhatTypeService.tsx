  ...
  return (
    <Box sx={classesStyle.content}>
      ...
      <Box sx={classesStyle.sectionObslujAll}>
        ...
        <Link href={"/obsluzhivaemye-obekty/torg-centry"} style={{ textDecoration: "none" }}>
          <Box sx={classesStyle.sectionObslujItem}>
            <Box sx={classesStyle.sectionImg}>
              <Image
            ...
            <Box sx={{ ...classesStyle.titleSub, color: COLOR_BLACK }}>Торговые центры</Box>
          </Box>
        </Link>
        <Link href={"/obsluzhivaemye-obekty/predpriytie"} style={{ textDecoration: "none" }}>
          <Box sx={classesStyle.sectionObslujItem}>
            <Box sx={classesStyle.sectionImg}>
              <Image
            ...
            <Box sx={{ ...classesStyle.titleSub, color: COLOR_BLACK }}>Предприятия</Box>
          </Box>
        </Link>
        <Link href={"/obsluzhivaemye-obekty/rozn-sety"} style={{ textDecoration: "none" }}>
          <Box sx={classesStyle.sectionObslujItem}>
            <Box sx={classesStyle.sectionImg}>
              <Image
                src={"/photo/5ka.jpg"}
            ...
            <Box sx={{ ...classesStyle.titleSub, color: COLOR_BLACK }}>Розничные сети</Box>
          </Box>
        </Link>
        <Link href={"/obsluzhivaemye-obekty/zapravochnye-stancii"} style={{ textDecoration: "none" }}>
          <Box sx={classesStyle.sectionObslujItem}>
            <Box sx={classesStyle.sectionImg}>
              <Image
            ...
            <Box sx={{ ...classesStyle.titleSub, color: COLOR_BLACK }}>Заправочные станции</Box>
          </Box>
        </Link>
      </Box>
    </Box>
